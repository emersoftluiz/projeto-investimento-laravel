...
class MovimentsController extends Controller
{
    ...
    public function storeApplication(Request $request){
        ...
        session()->flash('success', [
            'success' =>  true,
            'messages' => 'Sua Aplicação de '.$movimento->value.' no
                           Produto '.$movimento->product->name.' foi realizada com Sucesso',
        ]);
    ...
    public function storeGetBack(Request $request){
        ...
        session()->flash('success', [
            'success' =>  true,
            'messages' => 'Seu Resgate de '.$movimento->value.' no
                           Produto '.$movimento->product->name.' foi realizado com Sucesso',
        ]);
